// src/components/DocumentContent.jsx - MULTI-PAGE VERSION
...
const DocumentContent = ({ data, page = 1 }) => (
  <div className="document-content">
    ...
    {/* PAGE 2 - OBJEK TANAH & HARGA & PEMBAYARAN */}
    {page === 2 && (
      <>
        {/* Detail Objek */}
        <div className="section-break indent-sub">
          ...
          <p className="doc-paragraph">
            ...
            perjanjian ini dengan uraian sebagai berikut:
          </p>
      ...
      <>
        ...
        <div className="signature-section">
          <div className="signature-box">
            ...
            {data.adaIstri && (
              <p className="signature-name signature-name-istri">({data.namaIstri})</p>
            )}
          </div>
          <div className="signature-box">
